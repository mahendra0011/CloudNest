      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-900"
          ...
          {user ? (
            <div className="flex items-center gap-2">
              <div className="hidden items-center gap-2 sm:flex">
                ...
                <span className="max-w-[160px] truncate text-sm font-semibold text-slate-700 dark:text-slate-300">
                  {userLabel(user)}
                </span>
                {isAdmin && (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
                style={{ position: 'relative', zIndex: 10 }}
              >
                {status === 'loading' ? <Loader2 className="h-4 w-4 animate-spin" /> : <GoogleIcon className="h-4 w-4" />}
                {status === 'loading' ? 'Opening Google...' : 'Login with Google'}
              </button>
              <Link to="/login">
              ...
              <Link to="/register">
                <Button size="sm" className="rounded-xl bg-gd-blue font-semibold text-white shadow-gd-blue hover:bg-gd-blue-dark">
                  Sign Up
                </Button>
              </Link>
            </div>
